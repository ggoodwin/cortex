...
const categories: Array<{
  ...
  {
    slug: "ambiguous",
    label: "Ambiguous / Clarification",
    description:
      "Anything ambiguous that needs a clarifying question before proceeding, unclear requirements or vague requests",
    priority: 1
  },
  {
    slug: "multi-file-programming",
    label: "Multi-file Programming",
    description:
      "Multi-file higher impact programming and code tasks, large refactors, new features spanning multiple files, architectural code changes",
    priority: 2
  },
  {
    slug: "small-bug-fix",
    label: "Small Bug Fixes / Enhancements",
    description:
      "Smaller scope bug fixes and enhancement programming tasks, single-file patches, quick error corrections, minor improvements",
    priority: 3
  },
  {
    slug: "security-programming",
    label: "OSINT/Security Programming",
    description:
      "OSINT, pen testing, exploit development, malware analysis programming and code tasks, security-focused coding",
    priority: 4
  },
  {
    slug: "ui-design",
    label: "UI Design + Changes",
    description:
      "UI design and UI change work, visual component creation, layout adjustments, styling changes, frontend visual improvements",
    priority: 5
  },
  {
    slug: "research",
    label: "Research / Web Search",
    description: "Research and web search tasks, finding documentation, looking up APIs, general information gathering",
    priority: 6
  },
  {
    slug: "security-research",
    label: "OSINT/Security Research",
    description:
      "OSINT, pen testing, exploit research, malware research and web search, vulnerability research, threat intelligence",
    priority: 7
  },
  {
    slug: "simple-lookups",
    label: "Simple Lookups / Calendar / Email",
    description:
      "Simple lookups, calendar checks, email tasks, quick information retrieval, scheduling, basic communications",
    priority: 8
  },
  {
    slug: "complex-architecture",
    label: "Complex Architecture / Reasoning",
    description:
      "Complex architecture decisions, multi-step reasoning, system design, deep problem solving requiring careful thought",
    priority: 9
  },
  {
    slug: "translation",
    label: "Language Translation",
    description: "Language translation tasks, converting text between languages, localization work",
    priority: 10
  },
  {
    slug: "legal",
    label: "Legal Tasks",
    description: "Legal related tasks, contract review, compliance checks, legal research, terms of service analysis",
    priority: 11
  },
  {
    slug: "seo",
    label: "SEO Tasks",
    description:
      "SEO related tasks, search engine optimization, keyword research, meta tag optimization, content optimization for search",
    priority: 12
  },
  {
    slug: "writing",
    ...
    description:
      "Writing and content creation, blog posts, documentation, copywriting, creative writing, technical writing",
    priority: 13
  },
  {
    slug: "ux-critique",
    label: "UX Critique / Copy Review",
    description:
      "UX critique, positioning review, copy review, content quality assessment, brand voice checking, humanization of content",
    priority: 14
  },
  {
    slug: "data-analysis",
    ...
    description:
      "Data analysis, CSV processing, spreadsheet work, data visualization, statistical analysis, data cleaning",
    priority: 15
  },
  {
    slug: "image-generation",
    label: "Image Generation",
    description: "Image generation and editing work, creating visual assets, photo manipulation, graphic design tasks",
    priority: 16
  },
  {
    slug: "summarization",
    label: "Summarization",
    description: "Summarization tasks, condensing long content, creating abstracts, TL;DR generation, meeting notes",
    priority: 17
  },
  {
    slug: "devops",
    ...
    description:
      "DevOps and infrastructure tasks, CI/CD pipelines, server configuration, deployment automation, cloud infrastructure",
    priority: 18
  },
  {
    slug: "database",
    label: "Database / SQL Work",
    description:
      "Database and SQL work, schema design, query optimization, migrations, database architecture, indexing",
    priority: 19
  },
  {
    slug: "debugging",
    label: "Debugging / Error Triage",
    description:
      "Debugging and error triage, diagnosing errors, analyzing stack traces, identifying root causes, fixing runtime issues",
    priority: 20
  },
  {
    slug: "skill-creation",
    label: "Skill Creation",
    description: "Creating new skills, automation workflows, reusable task modules, plugin development",
    priority: 21
  },
  {
    slug: "git-review",
    label: "Git / PR / Code Review",
    description: "Git operations, pull request reviews, code review, merge conflict resolution, branch management",
    priority: 22
  },
  {
    slug: "security-audit",
    ...
    description:
      "Security audit, hardening, exposure review, vulnerability scanning, security assessment, compliance checking",
    priority: 23
  },
  {
    slug: "local-commands",
    ...
    description:
      "Tasks requiring local commands like git, pnpm, file edits, shell operations, system administration tasks",
    priority: 24
  }
];
...
export const BUILTIN_PRESETS: PresetDefinition[] = [
  {
    ...
    label: "Cheap",
    description:
      "Most affordable options that are still competent. Uses DeepSeek V3.2 for coding/reasoning and Gemini Flash Lite for simple tasks.",
  ...
  },
  {
    ...
    label: "Workhorse",
    description:
      "Best possible option in each category, ignoring cost. Claude Opus 4.6 for heavy lifting, Sonnet 4.6 for lighter tasks.",
