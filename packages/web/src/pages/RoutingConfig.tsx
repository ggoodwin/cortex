        ...
        <>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {activePreset.rules.sort((a, b) => a.priority - b.priority).map((rule) => (
                    ...
                    <td className="px-4 py-2">
                      {editingRule?.slug === rule.category_slug ? (
                        <div className="flex gap-2">
                          ...
                          />
                          <button onClick={saveRule} className="text-xs text-green-400 hover:text-green-300">Save</button>
                          <button onClick={() => setEditingRule(null)} className="text-xs text-zinc-500 hover:text-zinc-300">Cancel</button>
                        </div>
                      ) : (
